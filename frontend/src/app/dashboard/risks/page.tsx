...
export default function RisksPage() {
  ...
  useEffect(() => {
    ...
    // Fetch data from API
    console.log('Fetching Risk Management...');
  }, [accessToken]);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Identify and mitigate project risks</p>
        </div>
      ...
      <div className="card p-12 text-center">
        <h3 className="font-semibold mb-2">Risk Management Module</h3>
