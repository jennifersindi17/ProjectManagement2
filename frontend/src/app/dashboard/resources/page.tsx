...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    ...
    // Fetch data from API
    console.log('Fetching Resource Management...');
  }, [accessToken]);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage team resources and allocation</p>
        </div>
      ...
      <div className="card p-12 text-center">
        <h3 className="font-semibold mb-2">Resource Management Module</h3>
