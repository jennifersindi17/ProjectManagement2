...
export default function MeetingsPage() {
  ...
  useEffect(() => {
    ...
    // Fetch data from API
    console.log('Fetching Meetings & MOM...');
  }, [accessToken]);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Schedule meetings and record minutes</p>
        </div>
      ...
      <div className="card p-12 text-center">
        <h3 className="font-semibold mb-2">Meetings & MOM Module</h3>
