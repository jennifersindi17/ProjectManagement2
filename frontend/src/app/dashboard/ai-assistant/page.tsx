...
export default function AIAssistantPage() {
  ...
  useEffect(() => {
    ...
    // Fetch data from API
    console.log('Fetching AI Assistant...');
  }, [accessToken]);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">AI-powered project insights</p>
        </div>
      ...
      <div className="card p-12 text-center">
        <h3 className="font-semibold mb-2">AI Assistant Module</h3>
